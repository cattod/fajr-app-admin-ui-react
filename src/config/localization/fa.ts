export const fa = {
    ...
    rating_obj: {
        ...
        violence_range: 'میزان و شدت خشونت',
        insulting_range: 'میزان و شدت بددهانی و فحاشی',
        sexual_content: 'میزان نمایش محتوای جنسی',
        unsuitable_wearing: 'پوشش نامناسب',
        addiction_promotion: 'ترویج مصرف دخانیات و مواد مخدر',
        horror_content: 'محتوای ترسناک',
        suicide_encouragement: 'دعوت به خودکشی',
        breaking_law_encouragement: 'دعوت به نقض قانون',
        gambling_promotion: 'ترویج قمار',
        alcoholic_promotion: 'ترویج مصرف مشروبات الکلی',

        family_subject: 'نهاد خانواده',
        individual_social_behavior: 'اخلاق فردی و اجتماعی',
        feminism_exposure: 'مواجهه اصولی با مساله زن',
        justice_seeking: 'ظلم ستیزی و عدالت خواهی',
        theism: 'خدامحوری',
        bright_future_exposure: 'تصویر روشن از آینده جامعه',
        hope: 'امید',
